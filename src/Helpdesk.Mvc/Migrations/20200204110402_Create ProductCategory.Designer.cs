...
using Helpdesk.Mvc.Enum;
using System;

namespace Helpdesk.Mvc.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20200204110402_Create ProductCategory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Helpdesk.Mvc.Models.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Helpdesk.Mvc.Models.Product", b =>
                {
                    ...
                    b.HasOne("Helpdesk.Mvc.Models.ProductCategory")
                        .WithMany("products")
